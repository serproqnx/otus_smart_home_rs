...
struct Model {
  ...
  button_turn_on: button::State,
  button_turn_off: button::State,
  report: String,
}
...
impl Sandbox for Model {
  ...
  fn view(&mut self) -> Element<'_, Self::Message> {
    ...
    let button_turn_on = Button::new(&mut self.button_turn_on, Text::new("Turn on")).on_press(Message::TurnOn);
    let button_turn_off = Button::new(&mut self.button_turn_off, Text::new("Turn off")).on_press(Message::TurnOff);
